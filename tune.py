...
ds_config_dict = {
    ...
    "optimizer": {
        ...
        "params": {
            ...
            "lr": 2e-5,
            "weight_decay": 1,
            "comm_backend_name": "nccl" if sys.platform != "win32" else "gloo"
        }
    },
    "flops_profiler": {
        "enabled": False,
...
if __name__ == '__main__':
    ...
    with open('repositories/stanford_alpaca/alpaca_data.json', 'r') as f:
        data = json.load(f)
    ...
    trainer = Trainer(
        ...
        # Change to train_tokenized_dataset for full training
        train_dataset=small_train_dataset,
        # Change to eval_tokenized_dataset for full training
